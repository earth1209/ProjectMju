                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="col-md-6">
                        <div class="navbar-nav">
                            <a class="nav-item nav-link active" href="{{ route('officer.student_status') }}">สถานะการฝึกงานของนักศึกษา<span class="sr-only">(current)</span></a>
                            <a class="nav-item nav-link" href="{{ route('officer.stu_activity_hours') }}">ชั่วโมงกิจกรรม</a>
                        </div>
                    </div>
                    <div class="col-md-6 text-right">
                        <a href="{{ route('officer.form_status') }}"><button type="submit" class="btn">บันทึกข้อมูล</button></a>
                    </div>
                ...
                <div class="container">
                    <div class="card wow bounceInUp">
                        <table class="table table-hover table-striped table-bordered" >
                            ...
                            <tr>
                                <th class="text-center" scope="row" rowspan="">Edit</th>
                                <th class="text-center" scope="col" rowspan="">Delete</th>
                            </tr>
                            </thead>
                            <tbody>
                                {{-- @for ( $i=0 ; $i < 5; $i++) --}}
